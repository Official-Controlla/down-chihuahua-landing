...
useSeoMeta({
  title: "Donaciones y Colaboraciones | Instituto Down de Chihuahua A.C.",
  description: "Apoya la labor del Instituto Down de Chihuahua. Tus donaciones permiten mantener programas de estimulación temprana y educación inclusiva.",
});
    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-10">
      <header class="flex flex-col items-start gap-4 max-w-3xl">
        ...
        <p class="text-lg text-[#4a4a48]">
          Tu generosidad sostiene 40 años de historia y permite que más niñas, niños y adultos en Chihuahua accedan a
      ...
      <div class="p-8 md:p-10 rounded-3xl bg-[#0071bc] text-white flex flex-col gap-6 max-w-2xl">
        ...
        <p class="text-base text-[#fff5e0]">
          ...
          directamente con PayPal o ponerte en contacto con nuestro equipo.
        </p>
        <div class="flex flex-wrap items-center gap-4">
          <a href="https://www.paypal.com/donate/?hosted_button_id=SBY6NYQWH6CDJ" target="_blank"
            rel="noopener noreferrer">
            <Button label="Donar con PayPal" icon="pi pi-paypal"
              class="!bg-[#d9b421] !border-none !text-[#0071bc] !font-bold !rounded-full !px-6 !py-3 hover:!bg-[#c4a11c] transition-all" />
          </a>
          <a href="mailto:instituto@downchihuahua.org">
            <Button label="Contactar para Donar" icon="pi pi-envelope" outlined
              class="!border-2 !border-white !text-white !font-bold !rounded-full !px-6 !py-3 hover:!bg-white/10 transition-all" />
          </a>
        </div>
      </div>
    </div>
